		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					<li role="presentation" class="active"><a href="javascript:;">安装微信魔方系统</a></li>
					<li role="presentation"><a href="http://www.we7.cc">微信魔方官网</a></li>
			...
			<div class="footer" style="margin:15px auto;">
				<div class="text-center">
					<a href="https://yxymk.com">优选源码库</a> &nbsp; &nbsp; <a href="https://yxymk.comquestion?type=new_question">微信魔方帮助</a>
				</div>
				<div class="text-center">
					Powered by <a href="https://yxymk.com"><b>微信魔方</b></a>  &copy; 2018 <a href="https://yxymk.com">https://yxymk.com</a>
				</div>
			</div>
		</div>
		...
		<form class="form-inline" role="form" method="post">
			<ul class="pager">
				<li class="pull-left" style="display:block;padding:5px 10px 5px 0;">
					<div class="checkbox">
						<label>
							<input type="checkbox"> 继续安装
						</label>
					</div>
				</li>
				<li class="previous"><a href="javascript:;" onclick="if(jQuery(':checkbox:checked').length == 1){jQuery('form')[0].submit();}else{alert('您必须点击“继续安装”才能安装！')};">继续 <span class="glyphicon glyphicon-chevron-right"></span></a></li>
			</ul>
		</form>
EOF;
	tpl_frame();
